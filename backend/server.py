...
async def render_project_video(project_id: str, request: Request):
    ...
    asyncio.create_task(_run_render_job(
        ...
        talking_avatar_url=p.get("talking_avatar_url"),
        talking_avatar_mode=p.get("talking_avatar_mode") or "off",
    ))
